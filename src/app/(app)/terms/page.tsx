export default function TermsPage() {
  return (
    <div className="space-y-12 animate-in fade-in pb-12">
      <div>
        <p className="label-title mb-1.5 font-sans" style={{ fontFamily: 'Anthropic Sans, var(--font-inter), sans-serif' }}>Legal</p>
        <h1 className="page-title font-serif" style={{ fontFamily: 'Anthropic Serif, var(--font-merriweather), serif' }}>Terms & Conditions</h1>
        <p className="text-sm text-muted-foreground mt-2 max-w-xl leading-relaxed font-sans" style={{ fontFamily: 'Anthropic Sans, var(--font-inter), sans-serif' }}>
          By using this application, you are agreeing to our T & C.
        </p>
      </div>
        ...
        <div className="p-8 border border-border rounded-2xl bg-card text-left max-w-4xl mx-auto shadow-sm">
          <div className="prose prose-sm dark:prose-invert max-w-none space-y-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              These Terms and Conditions (hereinafter referred to as the "Terms", "Agreement", or "T&C") constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("User", "You", or "Your"), and Perenne LLC, operating under the exclusive ownership and directorship of Cius Unc ("Company", "We", "Us", or "Our"). This Agreement concerns your access to and use of the Perenne web application, as well as any other media form, media channel, mobile website, or mobile application related, linked, or otherwise connected thereto (collectively, the "Site"). You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms and Conditions. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS AND CONDITIONS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.
            </p>

            <h2 className="text-lg font-bold mt-6 text-foreground">2. Intellectual Property Rights</h2>
            <p className="text-muted-foreground leading-relaxed">
            ...
            <h2 className="text-lg font-bold mt-6 text-foreground">3. User Representations</h2>
            <p className="text-muted-foreground leading-relaxed">
            ...
            <h2 className="text-lg font-bold mt-6 text-foreground">4. Prohibited Activities</h2>
            ...
            <h2 className="text-lg font-bold mt-6 text-foreground">5. Limitation of Liability</h2>
            <p className="text-muted-foreground leading-relaxed">
            ...
            <h2 className="text-lg font-bold mt-6 text-foreground">6. Modifications and Interruptions</h2>
            <p className="text-muted-foreground leading-relaxed">
            ...
            <h2 className="text-lg font-bold mt-6 text-foreground">7. Governing Law</h2>
            <p className="text-muted-foreground leading-relaxed">
              These Terms and Conditions and your use of the Site are governed by and construed in accordance with the laws of the applicable jurisdiction, without regard to its conflict of law principles. Any legal action of whatever nature brought by either you or us (collectively, the "Parties" and individually, a "Party") shall be commenced or prosecuted in the state and federal courts, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction and forum non conveniens with respect to venue and jurisdiction in such state and federal courts. Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) are excluded from these Terms and Conditions. In no event shall any claim, action, or proceeding brought by either Party related in any way to the Site be commenced more than one (1) years after the cause of action arose.
            </p>
          </div>
        </div>
      </section>
